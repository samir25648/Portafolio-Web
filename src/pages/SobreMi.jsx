                    ...
                    <div className="lg:w-1/2 p-12 bg-custom rounded-3xl shadow-lg">
                        <div className="h-full text-center">
                            ...
                            <div className="flex justify-center ">
                                <ButtonIcon imgSrc="/assets/images/instagram.png" imgAlt="instagram" url="https://www.instagram.com/samir_alanya/"/>
                                <ButtonIcon imgSrc="/assets/images/github.png" imgAlt="github" url="https://github.com/samir25648"/>
                                <ButtonIcon imgSrc="/assets/images/linkedin.png" imgAlt="linkedin" url="https://www.linkedin.com/in/samir-brian-alanya-escobar/"/>
                                <ButtonIcon imgSrc="/assets/images/whatsapp.png" imgAlt="whatsapp" url="https://w.app/elmbcG"/>
                            </div>
                        </div>
                    </div>
                </div>
